...
const Description = ({ closeDescription }) => {
  return (
    <div className="modal-overlay ">
      <div className="relative phone:w-4/5 tablet:w-3/4 rounded-lg shadow-secondary shadow-sm h-full my-2 px-4 overflow-auto backdrop-blur-lg bg-black bg-opacity-40">
        <Heading text="CMS " />
        <button
          onClick={() => {
